      ...
      <form method="POST" class="login-form">
        <div class="row">
          <div class="input-field col s12 center">
            ...
            <h4 class="center login-form-text">Login in your account</h4>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="email" data-error="wrong" data-success="right" class="center-align">Enter your full name</label>
          </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
        ...
        <div class="row">
          <div class="input-field col s12">
            <button name="sub-btn-conn" class="btn waves-effect waves-light col s12">Login</button>
          </div>
        </div>
        <div class="row">
