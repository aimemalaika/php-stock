<?php
	...
	$timofy=date("Y");
	// for day
    $query = $con->prepare("SELECT SUM(`price`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totday` = ?" );
    ...
    $query1 = $con->prepare("SELECT SUM(`unit`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totday` = ?" );
    ...
    // for month
    $querymon = $con->prepare("SELECT SUM(`price`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totmont` = ?" );
    ...
    $querymon1 = $con->prepare("SELECT SUM(`unit`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totmont` = ?" );
    ...
    //for year
    $queryyear = $con->prepare("SELECT SUM(`price`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totyear` = ?" );
    ...
    $queryyear1 = $con->prepare("SELECT SUM(`unit`) FROM `companypurchasecred` WHERE `domaine` = ? AND `totyear` = ?" );
