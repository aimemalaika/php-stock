<?php
	...
	$timofy=date("Y");
	// for day
    $query = $con->prepare("SELECT SUM(`price`) FROM `companysalec` WHERE `domaine` = ? AND `totday` = ?" );
    ...
    $query1 = $con->prepare("SELECT SUM(`unit`) FROM `companysalec` WHERE `domaine` = ? AND `totday` = ?" );
    ...
    // for month
    $querymon = $con->prepare("SELECT SUM(`price`) FROM `companysalec` WHERE `domaine` = ? AND `totmont` = ?" );
    ...
    $querymon1 = $con->prepare("SELECT SUM(`unit`) FROM `companysalec` WHERE `domaine` = ? AND `totmont` = ?" );
    ...
    //for year
    $queryyear = $con->prepare("SELECT SUM(`price`) FROM `companysalec` WHERE `domaine` = ? AND `totyear` = ?" );
    ...
    $queryyear1 = $con->prepare("SELECT SUM(`unit`) FROM `companysalec` WHERE `domaine` = ? AND `totyear` = ?" );
