        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12 hidden light-primary-color" id="form-new-item">
                <form class="pad-x-sm" method="POST">
                    ...
                    <div class="form-group">
                        <button name="addpurchasecred" class="btn btn-default mibtn" type="submit">Save </button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading visible-sm-block visible-md-block visible-lg-block accent-color">
                                <h3 class="text-muted panel-title primary-text-color"><i class="fa fa-table"></i> Purchase / Table for product purchased on credit</h3></div>
                                            ...
                                            <form class="form-inline" method="get">
                                                <div class="form-group table-search">
                                                    <div class="input-group">
                                                        <input name="purchcrd" class="form-control" type="text" placeholder="Search" required>
                                    ...
                                    <div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                <?php
                                                    while ($dipselex = $selpurcred->fetch()) {?>
                                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="para-pad pull-left">
                                                    <p class="lead secondary-text-color">Showing <?=$departpc+1?> - 
                                                    <?php if (($departpc+$itemparpagepc)>$totalitempc) {
                                                       echo $totalitempc;
                                                    }else{echo ($departpc+$itemparpagepc);}?> of <?=$totalitempc?> Entries</p>
                                                </div>
                                                <div class="pull-right">
                                                    <nav>
                                                        <ul class="pagination">
                                                            ...
                                                            <?php
                                                            for ($i=1; $i <=(ceil($totalitempc / $itemparpagepc)) ; $i++) {
                                                            if($i == $_GET['page']){?>
                                                            <li class="active"><a><?=$i?></a></li>
                                                            <?php }else{?>
                                                                <li><a href="PurchaseCredit.php?page=<?=$i?>"><?=$i?></a></li>
                                                           <?php } } ?>
                                                        </ul>
                                                    </nav>
                                                </div>
