            ...
            <div class="col-md-3 col-sm-3 col-xs-12 hidden light-primary-color" id="form-new-item">
                <form method="POST" class="pad-x-sm">
                    <div class="form-group">
                        ...
                        <input placeholder="NAME" name="stockname" class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Coast </label>
                        <input name="stockcoast" class="form-control" placeholder="in FRW" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Description </label>
                        <textarea name="stockdesc" class="form-control" type="text"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Bougth on</label>
                        <input name="stocktime" placeholder="JJ/MM/YYYY" class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <button class="btn btn-default mibtn" name="addstock" type="submit">Save </button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading visible-sm-block visible-md-block visible-lg-block accent-color">
                                <h3 class="text-muted panel-title primary-text-color"><i class="fa fa-table"></i> Data for stock managemnt</h3></div>
                                            ...
                                            <form class="form-inline" method="get">
                                                <div class="form-group table-search">
                                                    <div class="input-group">
                                                        <input name="sestck" class="form-control" type="text" placeholder="Search" required>
                                    ...
                                    <div>
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                <?php
                                                    while ($dipass = $selstock->fetch()) {?>
                                                        <tr>
                                                            <td><?= $dipass['itemecode']?></td>
                                                            <td><?= $dipass['itemname']?></td>
                                                            <td><?= $dipass['description']?></td>
                                                            <td><?= $dipass['unit']?></td>
                                                            <td><?= $dipass['price']?> FRW</td>
                                                            <td><?= $dipass['Date_time']?></td>
                                                        </tr>   
                                                   <?php  } ?>
                                                </tbody>
                                            </table>
                                        ...
                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="para-pad pull-left">
                                                    ...
                                                    <?=$departstk+1?> - 
                                                    <?php if (($departstk+$itemparpagestk)>$totalitemstk) {
                                                       echo $totalitemstk;
                                                    }else{echo ($departstk+$itemparpagestk);}?> of <?=$totalitemstk?> Entries</p>
                                                </div>
                                                <div class="pull-right">
                                                    <nav>
                                                        <ul class="pagination">
                                                            <?php
                                                            for ($i=1; $i <=(ceil($totalitemstk / $itemparpagestk)) ; $i++) {
                                                            if($i == $_GET['page']){?>
                                                            <li class="active"><a><?=$i?></a></li>
                                                            <?php }else{?>
                                                                <li><a href="Stockmanagement.php?page=<?=$i?>"><?=$i?></a></li>
                                                           <?php } } ?>
                                                        </ul>
                                                    </nav>
                                                </div>
