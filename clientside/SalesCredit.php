        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12 hidden light-primary-color" id="form-new-item">
                <form class="pad-x-sm" method="POST">
                    ...
                    <div class="form-group">
                        <button name="addsalec" class="btn btn-default mibtn" type="submit">Save </button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="clearfix">
                            ...
                            <div class="pull-right button-g-div">
                                <ul class="list-inline">
                                   <?php
                                        while ($allsale = $sale->fetch()) { ?>
                                            <li class="mi-btn text-primary-color"><?=$allsale['futurename']?></li>
                                   <?php } ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading visible-sm-block visible-md-block visible-lg-block accent-color">
                                <h3 class="text-muted panel-title primary-text-color"><i class="fa fa-table"></i> Data Table of all sales on credit <span style="color: red" class="pull-right"><?php if (isset($ftrep)) {echo $ftrep;}?></span></h3></div>
                                            ...
                                            <form class="form-inline" method="get">
                                                <div class="form-group table-search">
                                                    <div class="input-group">
                                                        <input name="salcred" class="form-control" type="text" placeholder="Search" required>
                                        ...
                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="para-pad pull-left">
                                                    <p class="lead secondary-text-color">Showing <?=$departslc+1?> - 
                                                    <?php if (($departslc+$itemparpageslc)>$totalitemslc) {
                                                       echo $totalitemslc;
                                                    }else{echo ($departslc+$itemparpageslc);}?> of <?=$totalitemslc?> Entries</p>
                                                </div>
                                                <div class="pull-right">
                                                    <nav>
                                                        <ul class="pagination">
                                                            ...
                                                            <?php
                                                            for ($i=1; $i <=(ceil($totalitemslc / $itemparpageslc)) ; $i++) {
                                                            if($i == $_GET['page']){?>
                                                            <li class="active"><a><?=$i?></a></li>
                                                            <?php }else{?>
                                                                <li><a href="SalesCredit.php?page=<?=$i?>"><?=$i?></a></li>
                                                           <?php } } ?>
                                                        </ul>
                                                    </nav>
                                                </div>
