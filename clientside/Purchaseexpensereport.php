...
<head>
    ...
    <title>PURCHASE EXPENSES REPORT</title>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 hidden light-primary-color" id="form-new-item">
               <form method="POST" class="pad-x-sm">
                    <div class="form-group">
                        ...
                        <input placeholder="NAME" name="purexname" class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Coast </label>
                        <input name="purexcoast" class="form-control" placeholder="in FRW" type="text">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Description </label>
                        <textarea name="purexdesc" class="form-control" type="text"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">executed on</label>
                        <input name="purextime" id="datepicker" placeholder="JJ/MM/YYYY" class="form-control" type="text">
                    </div>
                    <div class="form-group">
                        <button class="btn btn-default mibtn" name="addpurex" type="submit">Save </button>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-heading visible-sm-block visible-md-block visible-lg-block accent-color">
                                <h3 class="text-muted panel-title primary-text-color"><i class="fa fa-table"></i> Data Table of purchases expenses</h3></div>
                                            ...
                                            <form class="form-inline" method="get">
                                                <div class="form-group table-search">
                                                    <div class="input-group">
                                                        <input name="seapex" class="form-control" type="text" placeholder="Search" required>
                                        ...
                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="para-pad pull-left">
                                                    ...
                                                    <?=$departper+1?> - 
                                                    <?php if (($departper+$itemparpageper)>$totalitemper) {
                                                       echo $totalitemper;
                                                    }else{echo ($departper+$itemparpageper);}?> of <?=$totalitemper?> Entries</p>
                                                </div>
                                                <div class="pull-right">
                                                    <nav>
                                                        <ul class="pagination">
                                                            <?php
                                                            for ($i=1; $i <=(ceil($totalitemper / $itemparpageper)) ; $i++) {
                                                            if($i == $_GET['page']){?>
